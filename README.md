# proxima
Merging proxy between Grafana and InfluxDB/OpenTSDB.

This is a proxy which fetches metrics time-series data from multiple back-end
databases (such as InfluxDB and OpenTSDB) and merges the time series together.
This is useful for when different databases have data at different time
resolutions and retention periods. The proxy delivers merged data to Grafana.
